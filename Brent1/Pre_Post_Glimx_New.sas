...
tdef t1 4 /llx=5    ulx=5   lrx=50   urx=50  lly=0    uly=25    lry=0      ury=25
        ...
        5 /llx=50   ulx=50  lrx=95   urx=95  lly=75   uly=100   lry=75     ury=100;
template t1;
tplay 1:27 2:28 3:29 4:30 5:31 6:32 7:33 8:34;
tplay 1:35 2:36 3:37 4:38;
run; quit;
ods pdf close;
...
tdef t1 4 /llx=5    ulx=5   lrx=50   urx=50  lly=0    uly=25    lry=0      ury=25
        ...
        5 /llx=50   ulx=50  lrx=95   urx=95  lly=75   uly=100   lry=75     ury=100;
template t1;
tplay 1:37 2:38 3:39 4:40 5:41 6:42 7:43 8:44;
tplay 1:45 2:46 3:47 4:48;
run; quit;
ods pdf close;
*/

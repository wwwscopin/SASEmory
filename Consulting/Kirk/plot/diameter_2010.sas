...
libname sav 'H:\SAS_Emory\Consulting\Kirk\plot';

options ls=132 ps=150;
...
proc print data=sav.diameter;   run;

data outdia; set sav.diameter;
...
Goptions device=APPLELW htext=2 ftext=triplex ROTATE=LANDSCAPE
...
return;
  ...
  axis1 label=(f=triplex h=2.5 'Phenotype') value=(f=triplex h=2.0) order=0 to 6 by 1;
  axis2 label=(f=triplex h=2.5 a=90 'Diameter') value=(f=triplex h=2.5) order=20 to 60 by 5;


proc gplot data=outdia gout=sav.graphs;
...
ODS TRACE OFF;
*/
proc print data=sav.perimeter;   run;



data outperi; set sav.perimeter;
  LC=LOWER; UC=UPPER; SEM=STDERR; MEAN=ESTIMATE;
...
return;
  ...
  axis1 label=(f=triplex h=2.5 'Phenotype') value=(f=triplex h=2.0) order=0 to 6 by 1;
  axis2 label=(f=triplex h=2.5 a=90 'Perimeter') value=(f=triplex h=2.5) order=60 to 150 by 10;


proc gplot data=outperi gout=sav.graphs;
  plot mean*age / frame haxis=axis1 vaxis=axis2
                       anno=b1;
...
return;
  ...
  axis1 label=(f=triplex h=2.5 'Phenotype') value=(f=triplex h=2.0) order=0 to 6 by 1;
  axis2 label=(f=triplex h=2.5 a=90 'CSA') value=(f=triplex h=2.5) order=200 to 1500 by 100;


proc gplot data=outcsa gout=sav.graphs;
  plot mean*age / frame haxis=axis1 vaxis=axis2
                       anno=b1;
***                      description='fig4a' name='fig4a';
...
ctext=black ftitle=triplex ftext=triplex htitle=2 htext=2

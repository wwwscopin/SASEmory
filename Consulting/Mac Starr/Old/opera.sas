...
ods rtf file="opera.rtf" style=journal bodytitle startpage=no;
...
proc report data=delta nowindows style=[just=center];
title "Comparsion by Post-Pre";
column idx avg stde pvalue; 
define idx/group order order=internal "Delta" style=[just=left];
define avg/ "Mean" format=4.1 style=[just=center];
define stde/"Stddev" format=4.1  style=[just=center];
define pvalue/ "p value" style=[just=center];
break after idx / dol dul;
run;
ods rtf close;

...
proc print; 
var ind pain1 pain0 delta_pain ;
run;

proc print data=stat1;run;

%let varlist=delta_pain delta_FE delta_ER delta_IR delta_ADL delta_ASES;
ods listing close;
...
ods rtf file="opera_delta.rtf" style=journal bodytitle startpage=no;

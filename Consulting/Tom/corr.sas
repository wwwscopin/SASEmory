...
%if %eval(&x in 8 9 10 11 12) %then %do;
...
data stat;
	set stat1 stat2 stat3 stat4 stat5 stat6 stat7 pc8 pc9 pc10 pc11 pc12; by item;
...
define pa/format=7.4 "Pearson  Correlation" style=[cellwidth=0.75in];

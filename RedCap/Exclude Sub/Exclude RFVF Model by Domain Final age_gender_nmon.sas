...
data symptom;
	...
	if sympt_caused=9 then sympt_caused=.;
...
data rfvf;
	...
	if mdy(10,12,2010)<=dt_visit<=mdy(12,18,2010) then delete;
	...
	*/
	...
	if dt_visit ne dt_refill_1 then do;
		pillday=dt_visit-min(of dt_refill_1-dt_refill_10);
	end;
	else if dt_visit=dt_refill_1 then do;
		pillday=dt_visit-min(of dt_refill_2-dt_refill_10);
	end;
	...
	*drop dt_refill_1-dt_refill_10 dispens1-dispens10;
	format age 4.1 type type. dt_visit yymmdd10. access_mpr access_mpr.;
run;
...
/*
proc freq data=rfvf;
tables faith*faith_act/chisq fisher;
run;
...
proc logistic data=rfvf plots=roc;
	class gender pay living /*faith*/ faith_act family_HIV_bin knows_hiv treat_support
		  aids_condition___27 rhiv arv_start arv_train_bin current_regimen med1 med2 med3 /param=ref ref=first;
	model idx(event="case")=age gender nmon pay edu living prin1 prin2 /*faith*/ faith_act family_HIV_bin knows_hiv treat_support
		  aids_condition___27 rhiv arv_start arv_train_bin current_regimen med1 med2 med3/selection=stepwise include=3
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit
				  clodds=pl;
	units age=5 edu=1 nmon=1 prin1=0.1 prin2=0.1;
run;
...
proc logistic data=rfvf plots=roc;
	class gender pay living clinic_feel 
		  practice_safe_bin dep_11 faith_act treat_support family_HIV_bin knows_hiv safe_sex/*faith*/
		  symptom_fatigue symptom_skin symptom_nervous symptom_sex symptom_diarr symptom_sad
		  aids_condition___6 aids_condition___27 non_aids_condition5
		  ses_num med1 med2 med3 current_regimen remember_meds___2 remember_meds___7 arv_train_bin rhiv arv_start/param=ref ref=first;
	model idx(event="case")=age gender nmon edu pay living prin1 prin2 
				 clinic_feel practice_safe_bin dep_11 faith_act treat_support family_HIV_bin knows_hiv safe_sex /*faith*/
		         symptom_fatigue symptom_skin symptom_nervous symptom_sex symptom_diarr symptom_sad
				 log_cd4 aids_condition___6 aids_condition___27 non_aids_condition5
				 ses_num med1 med2 med3 current_regimen remember_meds___2 remember_meds___7 arv_train_bin rhiv arv_start/selection=stepwise include=3
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit 
				  clodds=pl;
	units age=5 edu=1 nmon=1 log_cd4=1 prin1=0.1 prin2=0.1;
run;
...
proc logistic data=rfvf plots=roc;
	class gender pay living clinic_feel 
		  practice_safe_bin dep_11 faith_act treat_support family_HIV_bin knows_hiv safe_sex/param=ref ref=first;
	model idx(event="case")=age gender nmon mpr1 edu pay living prin1 prin2 clinic_feel practice_safe_bin 
		  dep_11 faith_act treat_support family_HIV_bin knows_hiv safe_sex/selection=stepwise include=4
                  slentry=0.3
                  slstay=0.35
                  details
				  lackfit clodds=pl;
	units age=5 edu=1 mpr1=0.1 nmon=1 prin1=0.1 prin2=0.1;
run;
...
proc logistic data=rfvf plots=roc;
	class gender clinic_feel practice_safe_bin dep_11 faith_act treat_support family_HIV_bin knows_hiv safe_sex 
		  symptom_fatigue symptom_diarr symptom_sad symptom_nervous symptom_skin symptom_sex 
		  aids_condition___6 aids_condition___27 non_aids_condition5
		  arv_start rhiv current_regimen ses_num arv_train_bin remember_meds___2 remember_meds___7 med1 med1 med2 med3 /param=ref ref=first;
	model idx(event="case")=age gender nmon pill
				 clinic_feel practice_safe_bin dep_11 faith_act treat_support family_HIV_bin knows_hiv safe_sex
		         symptom_fatigue symptom_diarr symptom_sad symptom_nervous symptom_skin symptom_sex 
			     log_cd4 aids_condition___6 aids_condition___27 non_aids_condition5
				 arv_start rhiv current_regimen ses_num arv_train_bin remember_meds___2 remember_meds___7 med1 med2 med3/selection=stepwise include=4
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit
				  clodds=pl;
	units age=5  nmon=1 pill=0.1 log_cd4=1;
run;
...
proc logistic data=rfvf plots=roc;
	class gender pay living 
		  clinic_feel practice_safe_bin dep_11 faith_act treat_support family_HIV_bin knows_hiv safe_sex
		  symptom_fatigue symptom_diarr symptom_sad symptom_nervous symptom_skin symptom_sex 
		  aids_condition___6 aids_condition___27 non_aids_condition5
		  arv_start rhiv current_regimen ses_num arv_train_bin remember_meds___2 remember_meds___7 med1 med2 med3/param=ref ref=first;
	model idx(event="case")=age gender nmon pill pay edu living prin1 prin2 
				 clinic_feel practice_safe_bin dep_11 faith_act treat_support family_HIV_bin knows_hiv safe_sex
		         symptom_fatigue symptom_diarr symptom_sad symptom_nervous symptom_skin symptom_sex 
				 log_cd4 aids_condition___6 aids_condition___27 non_aids_condition5
				 arv_start rhiv current_regimen ses_num arv_train_bin remember_meds___2 remember_meds___7 med1 med2 med3/
				  selection=stepwise include=4
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit 
				  clodds=pl;
	units age=5 edu=1 nmon=1 log_cd4=1 pill=0.1 prin1=0.1 prin2=0.1;
run;

...
run;
proc ttest data=rfvf;
	class idx;
	var pill;
run;

proc npar1way data=rfvf wilcoxon;
	class idx;
	var pill;
run;
ods graphics on;
proc sgscatter data=rfvf(where=(pill<2));
	plot mpr1*pill/group=idx;
run;
proc sgplot;
	scatter x=pill y=mpr1/group=idx;
run;
proc corr nomiss plots=matrix(histogram) spearman;
	var mpr1 pill;
run;
ods graphics off;
...
proc logistic data=rfvf plots=roc;
	class gender pay trans /*faith*/ faith_act family_HIV_bin treat_support
		  aids_condition___27 rhiv arv_start arv_train_bin current_regimen med1 med2 med3 /param=ref ref=first;
	model idx(event="case")=age gender nmon pay edu trans /*faith*/ faith_act family_HIV_bin treat_support
...
proc logistic data=rfvf plots=roc;
	class gender pay trans clinic_feel practice_safe_bin dep_11 faith_act treat_support family_HIV_bin /*faith*/
		  symptom_fatigue symptom_skin symptom_nervous symptom_sex symptom_diarr symptom_sad
		  aids_condition___27 non_aids_condition5
		  ses_num med1 med2 med3 current_regimen remember_meds___7 arv_train_bin rhiv arv_start/param=ref ref=first;
	model idx(event="case")=age gender nmon edu pay trans clinic_feel practice_safe_bin dep_11 faith_act treat_support family_HIV_bin /*faith*/
		         symptom_fatigue symptom_skin symptom_nervous symptom_sex symptom_diarr symptom_sad
				 log_cd4 aids_condition___27 non_aids_condition5
				 ses_num med1 med2 med3 current_regimen remember_meds___7 arv_train_bin rhiv arv_start/selection=stepwise include=3
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit 
...
proc logistic data=rfvf plots=roc;
	class gender pay trans dep_11 /*faith*/ faith_act family_HIV_bin 
		  practice_safe_bin treat_support clinic_feel /param=ref ref=first;
	model idx(event="case")=age gender nmon mpr1 edu pay trans dep_11 /*faith*/ faith_act
		         family_HIV_bin practice_safe_bin treat_support clinic_feel/selection=stepwise include=4
                  slentry=0.3
                  slstay=0.35
                  details
				  lackfit clodds=pl;
...
proc logistic data=rfvf plots=roc;
	class gender dep_11 /*faith*/ faith_act family_HIV_bin practice_safe_bin treat_support clinic_feel 
	...
	model idx(event="case")=age gender nmon pill dep_11 /*faith*/ faith_act family_HIV_bin
		         practice_safe_bin treat_support clinic_feel
		         symptom_fatigue symptom_diarr symptom_sad symptom_nervous symptom_skin symptom_sex 
			     log_cd4 aids_condition___27 non_aids_condition5
				 arv_start rhiv current_regimen ses_num arv_train_bin remember_meds___7 med1 med2 med3 /selection=stepwise include=4
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit
...
proc logistic data=rfvf plots=roc;
	class gender pay trans dep_11 /*faith*/ faith_act family_HIV_bin practice_safe_bin treat_support clinic_feel 
		  symptom_fatigue symptom_diarr symptom_sad symptom_nervous symptom_skin symptom_sex 
		  aids_condition___27 non_aids_condition5
		  arv_start rhiv current_regimen ses_num arv_train_bin remember_meds___7 med1 med2 med3/param=ref ref=first;
	model idx(event="case")=age gender nmon pill pay edu trans dep_11 /*faith*/ faith_act family_HIV_bin practice_safe_bin treat_support clinic_feel
		         symptom_fatigue symptom_diarr symptom_sad symptom_nervous symptom_skin symptom_sex 
				 log_cd4 aids_condition___27 non_aids_condition5
				 arv_start rhiv current_regimen ses_num arv_train_bin remember_meds___7 med1 med2 med3/selection=stepwise include=4
                  slentry=0.3

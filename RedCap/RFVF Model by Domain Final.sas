...
proc logistic data=rfvf plots=roc;
	...
	model idx(event="case")=age gender pay edu trans faith faith_act family_HIV_bin treat_support
		  aids_condition___27 rhiv arv_start arv_train_bin current_regimen med1 med2 med3 nmon/selection=stepwise
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit
...
proc logistic data=rfvf plots=roc;
	...
	model idx(event="case")=age gender pay edu trans dep_11 faith faith_act family_HIV_bin practice_safe_bin treat_support clinic_feel
		         symptom_fatigue symptom_diarr symptom_sad symptom_nervous symptom_skin symptom_sex 
...
proc logistic data=rfvf plots=roc;
	...
	model idx(event="case")=age gender pay edu trans dep_11 faith faith_act
		         family_HIV_bin practice_safe_bin treat_support clinic_feel mpr1/selection=stepwise
                  slentry=0.3
                  slstay=0.35
                  details
				  lackfit clodds=pl;
	units age=5 edu=1 mpr1=0.1 ;
run;
...
proc logistic data=rfvf plots=roc;
	class gender pay trans dep_11 faith faith_act family_HIV_bin 
		  practice_safe_bin treat_support clinic_feel /param=ref ref=first;
	model idx(event="case")=age gender pay edu trans dep_11 faith faith_act
		         family_HIV_bin practice_safe_bin treat_support clinic_feel mpr1/lackfit clodds=pl;
	units age=5 edu=1 mpr1=0.1 ;
run;
...
proc logistic data=rfvf plots=roc;
	class gender dep_11 faith faith_act family_HIV_bin practice_safe_bin treat_support clinic_feel 
		  ...
		  aids_condition___27 non_aids_condition5
		  arv_start rhiv current_regimen ses_num arv_train_bin remember_meds___7 med1 med2 med3 /param=ref ref=first;
	model idx(event="case")=age gender dep_11 faith faith_act family_HIV_bin
...
proc logistic data=rfvf plots=roc;
	class gender trans dep_11 faith faith_act family_HIV_bin practice_safe_bin treat_support clinic_feel 
		  symptom_fatigue symptom_diarr symptom_sad symptom_skin 
		  aids_condition___27 non_aids_condition5
		  arv_start rhiv current_regimen ses_num arv_train_bin remember_meds___7 med1 med2 med3/param=ref ref=first;
	model idx(event="case")=age gender edu trans dep_11 faith faith_act family_HIV_bin practice_safe_bin treat_support clinic_feel
		         symptom_fatigue symptom_diarr symptom_sad symptom_skin 
				 log_cd4 non_aids_condition5
				 rhiv current_regimen ses_num remember_meds___7 med1 med2 
				 mpr1 pill/lackfit   clodds=pl;
	units age=5 edu=1 log_cd4=1 mpr1=0.1 pill=0.1;
run;
ods graphics off;

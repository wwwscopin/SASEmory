...
data rfvf;
	...
	mpr1=(dispens-(max(of last[*])-min(of refill[*])-180))/180;
...
ods listing close;
* From Demo form;
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=age, type=con, label="Age", first_var=1, title="Comparison between Case and Control from Earliest Refill");

* Other variables;
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=nmon, type=con, label="Duration of ART (months)" );

%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=mpr1, type=con, label="MPR" , decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=Q_mpr1, type=cat, label="MPR by Quartile" , decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=mean_mpr, type=cat, label="MPR by Mean" , decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=median_mpr, type=cat, label="MPR by Median" , decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=p80_mpr, type=cat, label="MPR by p80" , decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=p85_mpr, type=cat, label="MPR by p85" , decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=p90_mpr, type=cat, label="MPR by p90" , decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=p95_mpr, type=cat, label="MPR by p95" , decmax=2);

%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=pill, type=con, label="Adherence" , decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=Q_pill, type=cat, label="Adherence by Quartile" ,decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=mean_pill, type=cat, label="Adherence by Mean" , decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=median_pill, type=cat, label="Adherence by Median" , decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=p80_pill, type=cat, label="Adherence by p80" , decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=p85_pill, type=cat, label="Adherence by p85" , decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=p90_pill, type=cat, label="Adherence by p90" , decmax=2);
%table(data_in=rfvf,data_out=refill_tab1,gvar=idx,var=p95_pill, type=cat, label="Adherence by p95" , decmax=2, last_var=1);
ods listing;
*/

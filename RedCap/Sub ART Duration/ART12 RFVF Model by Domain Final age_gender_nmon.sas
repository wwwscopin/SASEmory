...
proc logistic data=rfvf plots=roc;
	class gender employ living partner /*faith*/ faith_act family_HIV_bin treat_support
		  aids_condition___27 rhiv arv_start arv_train_bin current_regimen med1 med2 med3 /param=ref ref=first;
	model idx(event="case")=age gender nmon edu prin1 employ living partner/*faith*/ faith_act family_HIV_bin treat_support
		  aids_condition___27 rhiv arv_start arv_train_bin current_regimen med1 med2 med3/selection=stepwise include=3
                  ...
                  lackfit
				  clodds=pl;
	units age=5 edu=1 nmon=1 prin1=0.1;
run;
...
proc logistic data=rfvf plots=roc;
	class gender employ living partner clinic_feel practice_safe_bin dep_11 faith_act treat_support family_HIV_bin safe_sex/*faith*/
		  symptom_skin 
		  ses_num med2 current_regimen remember_meds___7 arv_start/param=ref ref=first;
	model idx(event="case")=age gender nmon edu prin1 employ living 
				 partner clinic_feel practice_safe_bin dep_11 faith_act treat_support family_HIV_bin safe_sex/*faith*/
		         symptom_skin karn_score
				 log_cd4 
				 med2 current_regimen remember_meds___7 arv_start/selection=stepwise include=3
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit 
				  clodds=pl;
	units age=5 edu=1 nmon=1 log_cd4=1 prin1=0.1 karn_score=10;
run;
...
proc logistic data=rfvf plots=roc;
	class gender employ living partner dep_11 /*faith*/ faith_act family_HIV_bin safe_sex
		  practice_safe_bin treat_support clinic_feel /param=ref ref=first;
	model idx(event="case")=age gender nmon mpr1 edu prin1 employ living partner dep_11 /*faith*/ faith_act
		         family_HIV_bin practice_safe_bin treat_support clinic_feel safe_sex/selection=stepwise include=4
                  slentry=0.3
                  slstay=0.35
                  details
				  lackfit clodds=pl;
	units age=5 edu=1 mpr1=0.1 nmon=1 prin1=0.1;
run;
...
proc logistic data=rfvf plots=roc;
	class gender partner dep_11 /*faith*/ faith_act family_HIV_bin practice_safe_bin treat_support clinic_feel safe_sex
		  symptom_skin
		  arv_start current_regimen remember_meds___7 med2 /param=ref ref=first;
	model idx(event="case")=age gender nmon pill partner dep_11 /*faith*/ faith_act family_HIV_bin safe_sex
		         practice_safe_bin treat_support clinic_feel
		         symptom_skin karn_score log_cd4 
				 arv_start current_regimen remember_meds___7 med2 /selection=stepwise include=4
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit
				  clodds=pl;
	units age=5  nmon=1 pill=0.1 log_cd4=1 karn_score=10;
run;
...
proc logistic data=rfvf plots=roc;
	class gender employ living partner dep_11 /*faith*/ faith_act family_HIV_bin practice_safe_bin treat_support clinic_feel safe_sex 
		  symptom_skin 
		  arv_start current_regimen remember_meds___7 med2/param=ref ref=first;
	model idx(event="case")=age gender nmon pill edu prin1 employ living partner 
				 dep_11 /*faith*/ faith_act family_HIV_bin practice_safe_bin treat_support clinic_feel safe_sex
		         symptom_skin karn_score log_cd4 
				 arv_start current_regimen remember_meds___7 med2/selection=stepwise include=4
                  slentry=0.3
                  slstay=0.35
                  ...
                  lackfit 
				  clodds=pl;
	units age=5 edu=1 nmon=1 log_cd4=1 pill=0.1 karn_score=10;
run;

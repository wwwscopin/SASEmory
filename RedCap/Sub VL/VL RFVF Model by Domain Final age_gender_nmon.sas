...
proc format;
	...
	*/
	...
	value vl_level 0="VL<50" 1="VL>=50";
...
data rfvf;
	...
	if VL>49 then vl_level=1; else vl_level=0;
	...
	*drop dt_refill_1-dt_refill_10 dispens1-dispens10;
	format age 4.1 type type. dt_visit yymmdd10. access_mpr access_mpr. vl_level vl_level.;
run;
...
proc logistic data=rfvf plots=roc;
	class gender pay trans /*faith*/ faith_act family_HIV_bin knows_hiv treat_support
		  aids_condition___27 rhiv arv_start arv_train_bin current_regimen med1 med2 med3 /param=ref ref=first;
	model idx(event="case")=age gender nmon pay edu trans /*faith*/ faith_act family_HIV_bin knows_hiv treat_support
...
proc logistic data=rfvf plots=roc;
	class gender pay trans clinic_feel practice_safe_bin dep_11 faith_act treat_support /*faith*/ knows_hiv cheer_bin 
		  symptom_fatigue symptom_skin symptom_nervous symptom_sex symptom_diarr symptom_rememb symptom_hair
		  aids_condition___6 aids_condition___27 non_aids_condition5
		  ses_num med1 med2 med3 med4 current_regimen remember_meds___2 remember_meds___7 arv_train_bin rhiv arv_start/param=ref ref=first;
	model idx(event="case")=age gender nmon edu pay trans clinic_feel practice_safe_bin dep_11 faith_act treat_support knows_hiv cheer_bin /*faith*/
		         symptom_fatigue symptom_skin symptom_nervous symptom_sex symptom_diarr symptom_rememb symptom_hair
				 log_cd4 aids_condition___6 aids_condition___27 non_aids_condition5
				 ses_num med1 med2 med3 med4 current_regimen remember_meds___2 remember_meds___7 arv_train_bin rhiv arv_start/selection=stepwise include=3
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit 
...
proc logistic data=rfvf plots=roc;
	class gender pay trans dep_11 /*faith*/ faith_act knows_hiv cheer_bin 
		  practice_safe_bin treat_support clinic_feel /param=ref ref=first;
	model idx(event="case")=age gender nmon mpr1 edu pay trans dep_11 /*faith*/ faith_act knows_hiv cheer_bin 
		          practice_safe_bin treat_support  clinic_feel /selection=stepwise include=4
                  slentry=0.3
                  slstay=0.35
                  details
				  lackfit clodds=pl;
	units age=5 edu=1 mpr1=0.1 nmon=1;
run;
...
proc logistic data=rfvf plots=roc;
	class gender dep_11 /*faith*/ faith_act knows_hiv cheer_bin practice_safe_bin treat_support clinic_feel 
		  symptom_fatigue symptom_diarr symptom_rememb symptom_nervous symptom_skin symptom_sex symptom_hair
		  aids_condition___6 aids_condition___27 non_aids_condition5
		  arv_start rhiv current_regimen ses_num arv_train_bin remember_meds___7 med1 med2 med3 /param=ref ref=first;
	model idx(event="case")=age gender nmon pill dep_11 /*faith*/ faith_act knows_hiv cheer_bin 
		         practice_safe_bin treat_support clinic_feel
		         symptom_fatigue symptom_diarr symptom_rememb symptom_nervous symptom_skin symptom_sex symptom_hair
			     log_cd4 aids_condition___6 aids_condition___27 non_aids_condition5
				 arv_start rhiv current_regimen ses_num arv_train_bin remember_meds___2 remember_meds___7 med1 med2 med3 med4/selection=stepwise include=4
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit
...
proc logistic data=rfvf plots=roc;
	class gender pay trans dep_11 /*faith*/ faith_act knows_hiv cheer_bin practice_safe_bin treat_support clinic_feel 
		  symptom_fatigue symptom_diarr symptom_rememb symptom_nervous symptom_skin symptom_sex symptom_hair
		  aids_condition___6 aids_condition___27 non_aids_condition5
		  arv_start rhiv current_regimen ses_num arv_train_bin remember_meds___2 remember_meds___7 med1 med2 med3 med4/param=ref ref=first;
	model idx(event="case")=age gender nmon pill pay edu trans dep_11 /*faith*/ faith_act knows_hiv cheer_bin practice_safe_bin treat_support clinic_feel
		         symptom_fatigue symptom_diarr symptom_rememb symptom_nervous symptom_skin symptom_sex symptom_hair
				 log_cd4 aids_condition___6 aids_condition___27 non_aids_condition5
				 arv_start rhiv current_regimen ses_num arv_train_bin remember_meds___2 remember_meds___7 med1 med2 med3 med4/selection=stepwise include=4
                  slentry=0.3
                  ...
                  lackfit 
				  clodds=pl;
	units age=5 edu=1 nmon=1 log_cd4=1 pill=0.1;
run;

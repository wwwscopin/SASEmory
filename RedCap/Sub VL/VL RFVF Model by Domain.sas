...
ods graphics on;
/** Demo Access Adherence **/
proc logistic data=rfvf plots=roc;
	class gender race/param=ref ref=first;
	model idx(event="case")=age gender race /selection=stepwise
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit;
...
/** Socioeconomic with Qusi-Complete Issue if with Trans **/
proc logistic data=rfvf plots=roc;
	class income employ pay living trans /param=ref ref=first;
	model idx(event="case")=edu income prin1 prin2 employ pay living trans /selection=stepwise
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit;
...
proc logistic data=rfvf plots=roc;
	class faith /*faith_specify*/ faith_act traditional_ever partner ptest ppos safe_sex safe_condom
		  hcw_touch treat_poorly rejected talk_loud knows_hiv practice_safe practice_safe_bin
		  treat_support clinic_feel	 tired  nervous nervous_rate restless depressed effort worthless
		  dep_11 depressed_bin cheer_bin /*effort_bin*/ nervous_bin restless_bin family_HIV_bin/param=ref ref=first;
	model idx(event="case")=faith /*faith_specify*/ faith_act traditional_ever partner ptest ppos safe_sex safe_condom
		  hcw_touch treat_poorly rejected talk_loud knows_hiv practice_safe practice_safe_bin
		  treat_support clinic_feel	 total_score tired  nervous nervous_rate restless depressed effort worthless
		  dep_11 depressed_bin cheer_bin /*effort_bin*/ nervous_bin restless_bin family_HIV_bin family_HIV/selection=stepwise
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit;
...
/** Symptom Model **/
proc logistic data=rfvf plots=roc;
	class symptom_fatigue symptom_fever symptom_rememb symptom_vomit symptom_diarr symptom_sad symptom_nervous symptom_sleep 
			symptom_skin symptom_head symptom_gi symptom_sex symptom_waste symptom_hair sympt_caused 
			type/param=ref ref=first;

	model idx(event="case")=symptom_fatigue symptom_fever symptom_rememb symptom_vomit symptom_diarr symptom_sad symptom_nervous symptom_sleep 
			symptom_skin symptom_head symptom_gi symptom_sex symptom_waste symptom_hair sympt_caused
		    karn_score type /selection=stepwise
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit;
...
proc logistic data=rfvf plots=roc;
	class cd4_350 aids_condition___6 aids_condition___27 non_aids_condition5 non_aids_condition16/param=ref ref=first;
	model idx(event="case")=cd4 log_cd4 cd4_350 num aids_condition___6 aids_condition___27 non_aids_condition5  non_aids_condition16/selection=stepwise
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit;
...
/** Medications **/
proc logistic data=rfvf plots=roc;
	class arv_start rhiv current_regimen hiv_educate ses_num arv_train arv_train_bin
		remember_meds___2 remember_meds___3 remember_meds___7 remember_meds_other med1 med2 med3 med4/param=ref ref=first;
	model idx(event="case")=nmon arv_start rhiv current_regimen hiv_educate ses_num arv_train arv_train_bin 
		remember_meds___2 remember_meds___3 remember_meds___7 remember_meds_other med1 med2 med3 med4 /selection=stepwise
                  slentry=0.3
                  slstay=0.35
                  details
                  lackfit;

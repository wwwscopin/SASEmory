...
data estimate_&var;
	...
	num_&var(where=(pe=0) keep=censor day num_obs rename=(num_obs=n0))
	num_&var(where=(pe=1) keep=censor day num_obs rename=(num_obs=n1))
	diff; by day;
...
proc print data=adamts13 noobs label;
title "Adamts13 vs Days on Study";
...
proc print data=vwf_ag noobs label;
title "vWf Antigen vs Days on Study";
var day col0 col1/style=[just=center cellwidth=1.5 in];
label day="Treatment Day"
	  col0="No Plasma Exchange"
	  col1="Plasma Exchange";
...
title "Platelet vs Days on Study";
var day col0 col1/style=[just=center cellwidth=1.5 in];
label day="Treatment Day"
	  col0="No Plasma Exchange"
	  col1="Plasma Exchange";
...
proc print data=vwf_rca noobs label;
title "vWF Ristocetin Cofactor Activity vs Days on Study";
var day col0 col1/style=[just=center cellwidth=1.5 in];
label day="Treatment Day"
	  col0="No Plasma Exchange"
	  col1="Plasma Exchange";

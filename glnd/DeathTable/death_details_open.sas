...
ods pdf file = "/glnd/sas/reporting/death_details_emory.pdf" style=journal;
ods ps file = "/glnd/sas/reporting/deathdetailsemory.ps" style=journal;
	title2 h=2 "Emory";

...
data infect;
    set glnd.info (keep = id apache_2 ni_any ni_bsi ni_lri);
...
%mixed(cyto,log_il6,any,&ylab, &title); run; 
	...
	ods pdf file = "glnd_infec_any.pdf";
...
ods tagsets.excelxp file="glnd_infect_any.xls";
...
ods tagsets.excelxp close;
	...
	ods  rtf  file="GLND_any.rtf" style=journal bodytitle startpage=never;

...
%mixed(flag_lps,anti_lps_IgM,hospital_death,&ylab, &title); run; 
	...
	ods pdf file = "flag_lps_bydeath.pdf";
...
ods tagsets.excelxp file="flag_lps_bydeath.xls";
...
ods tagsets.excelxp close;
	...
	ods  rtf  file="flag_lps_bydeath.rtf" style=journal bodytitle startpage=never;
	/*

...
proc genmod data =tmp ;
	class &trt id day ; 	
	model &var=&trt day &trt*day/dist =poisson link = log type3 noscale; 
...
%mixed(flag_lps,anti_lps_IgM,treatment,&ylab, &title); run; 
	...
	ods pdf file = "flag_lps_bytrt_wk2.pdf";
...
ods tagsets.excelxp file="flag_lps_bytrt_wk2.xls";
/*
ods tagsets.excelxp
...
ods tagsets.excelxp close;
	...
	ods  rtf  file="flag_lps_bytrt_wk2.rtf" style=journal bodytitle startpage=never;
	/*

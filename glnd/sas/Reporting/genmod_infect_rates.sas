...
ods rtf file="genmod_rates_hosp.rtf" style=journal bodytitle;
ods escapechar="^";
proc print data=rate split="*" noobs label; 
title1 "Table 1: Incident Infection Rates: AG-PN = &na patients, STD-PN = &nb patients";
title2 "(Patient hospital days observed: AG-PN = &daya days, STD-PN = &dayb days)";
...
^n 2. Infection rates per 1000 hospital days were estimated and compared using Poisson 

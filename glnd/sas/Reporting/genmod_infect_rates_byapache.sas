...
ods rtf file="genmod_rates_Hosp_enroll_apache2.rtf" style=journal bodytitle;
ods escapechar="^";
...
*title1 "Table 2a: Incident Infection Rates for Apache<=&ap1(First Quartile for Apache at Enrollment):";
title1 "Table 2b: Incident Infection Rates for Apache=12-16(Second Quartile for Apache at Enrollment):";

...
series x=day y=gluc_all;
scatter x=day y=gluc_all/group=treatment;
run;
proc print data=all_glucose;
...
proc sgplot;
where id in(22042,42008,51071);
series x=day y=glucose;
scatter x=day y=glucose/group=treatment;
run;

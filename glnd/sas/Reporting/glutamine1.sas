...
data z;
  ...
  by id;
   if a;
ods pdf file='glutamine1.pdf';
proc print;
 var id  glut0--glut28 collectionday dfcreate dt_random treatment;
title All GlutamicAcid Data;
run;
data z1;
  set z;
  if dfcreate ne '';
proc sort; by dfcreate;
proc print;
 var id  glut0--glut28  dfcreate dt_random treatment;
title IDataFax GlutamicAcid Data;
run;

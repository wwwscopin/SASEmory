...
************************************************************************************************************;
		...
		proc mixed data = hspp empirical covtest;
		...
		* merge the means and CIs into gluc_box to obtain plotting dataset;
		proc sort data = hspp out=tmp; by visit; run;
		...
		run;
         		...
         		proc gplot data=hsp_mean gout=glnd_rep.graphs;

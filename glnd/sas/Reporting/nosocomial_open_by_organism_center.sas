	...
	* go through data, currently arranged on a per-episode basis, and stack by organism ;
	data by_organism;
		...
		* work backwards from oganism_5,  ... ;
		...
		if id=22018 and cult_org_code=20 and infect_visitno=103 then organism="Other fungal species - Yeast not specified";
    	if id=22021 and cult_org_code=20 and infect_visitno=101 then organism="Other fungal species - Yeast not specified";

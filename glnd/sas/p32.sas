/* CREATED BY: esrose2 Jun 13,2007 12:28PM using DFsas */
/*   VERSIONS: DFsas 3.7-004, 05/06/14 and .DFsas.awk 3.7-004, 05/06/14 */
options YEARCUTOFF=1920;

filename data1 '/dfax/glnd/sas/plate32.d01';
data glnd.plate32(label="Day XX Follow-Up Form, Pg 1/8");
  ...
  input id  DFSTATUS  DFVALID  DFRASTER $  DFSTUDY  DFPLATE  DFSEQ
        ptint $  fcbint $  dfc  tot_pn  oral_prot  pn_aa_g  oral_kcal
        pn_aa_kcal  iv_kcal  pn_lipid  prop_kcal  pn_cho  tot_aa
        tube_prot  tot_kcal  tube_kcal  tot_insulin  gluc_eve
        eve_gluc_src  time_gluc_eve $  gluc_mrn  mrn_gluc_src
        time_gluc_mrn $  gluc_aft  aft_gluc_src  time_gluc_aft $
        sofa_resp  sofa_coag  sofa_liver  sofa_cardio  sofa_cns
        sofa_renal  sofa_tot  nar_prov  DFSCREEN  DFCREATE $  DFMODIFY $ ;

...
filename data1 '/dfax/glnd/sas/plate102.d01';
data glnd.plate102(label="Suspected Nosocomial Infection, Pg 2/4");
  infile data1 LRECL=4096 dlm='|' missover dsd;
  informat DFRASTER $CHAR12. ;
  informat org_spec_2 $CHAR80. ;
  informat dt_cult_rec_2 MMDDYY8. ;  format dt_cult_rec_2  MMDDYY8. ;
  informat dt_cult_rep_fax_2 MMDDYY8. ;  format dt_cult_rep_fax_2  MMDDYY8. ;
  informat org_spec_3 $CHAR80. ;
  informat dt_cult_rec_3 MMDDYY8. ;  format dt_cult_rec_3  MMDDYY8. ;
  informat dt_cult_rep_fax_3 MMDDYY8. ;  format dt_cult_rep_fax_3  MMDDYY8. ;
  informat org_spec_4 $CHAR80. ;
  informat dt_cult_rec_4 MMDDYY8. ;  format dt_cult_rec_4  MMDDYY8. ;
  informat dt_cult_rep_fax_4 MMDDYY8. ;  format dt_cult_rep_fax_4  MMDDYY8. ;
  informat org_spec_5 $CHAR80. ;
  informat dt_cult_rec_5 MMDDYY8. ;  format dt_cult_rec_5  MMDDYY8. ;
  informat dt_cult_rep_fax_5 MMDDYY8. ;  format dt_cult_rep_fax_5  MMDDYY8. ;
  ...
  format cult_org_code_2 cult_org_code.;
  format cult_site_code_2 cult_site_code.; 
  format cult_org_code_3 cult_org_code.;
  format cult_site_code_3 cult_site_code.; 
  format cult_org_code_4 cult_org_code.;
  format cult_site_code_4 cult_site_code.; 
  format cult_org_code_5 cult_org_code.;
  format cult_site_code_5 cult_site_code.; 
  ...
  label id="GLND ID No."
	...
	if esbl_2 = 99 then esbl_2 = .;
	if esbl_3 = 99 then esbl_3 = .;
	if esbl_4 = 99 then esbl_4 = .;
	if esbl_5 = 99 then esbl_5 = .;

/* CREATED BY: esrose2 Aug 23,2007 13:50PM using DFsas */
/*   VERSIONS: DFsas 3.8.2, May and .DFsas.awk 3.8.2, May */
options YEARCUTOFF=1920;


filename data1 '/dfax/glnd/sas/plate18.d01';
data glnd.plate18(label="Concomitant Medications Form, Pg 1/4");
...
proc sort data= glnd.plate18; by id ; run;

proc print data= glnd.plate18;
	by id;
run;

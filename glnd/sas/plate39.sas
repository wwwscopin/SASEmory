/* CREATED BY: esrose2 Mar 21,2007 13:45PM using DFsas */
/*   VERSIONS: DFsas 3.7-004, 05/06/14 and .DFsas.awk 3.7-004, 05/06/14 */
options YEARCUTOFF=1920;


filename data1 '/dfax/glnd/sas/plate39.d01';
data glnd.plate39(label="Day XX Follow-Up Form, Pg 8/8");
  ...
  label id="GLND ID No."
        ...
        ards="2.3 ARDS present?"
        dt_new_ards="2.3 Date of new ARDS"
        mech_vent="2.4 Mechanical Vent."
        mech_vent_updt="2.4 Mech Vent Update"
        ...
        ae="4.1 AE?"
        sae="4.2 SAE?"
        concom_meds="5.1 Concomitant meds"
        meds_updt="5.2 Meds form updated?"

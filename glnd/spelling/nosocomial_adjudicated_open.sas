...
/*
		if lowcase(strip(org_spec_1))='Klebsiella not specified' then org_spec_1='not specified';
		if lowcase(strip(org_spec_2))='Klebsiella not specified' then org_spec_2='not specified';
		if lowcase(strip(org_spec_3))='Klebsiella not specified' then org_spec_3='not specified';
		if lowcase(strip(org_spec_4))='Klebsiella not specified' then org_spec_4='not specified';
		if lowcase(strip(org_spec_5))='Klebsiella not specified' then org_spec_5='not specified';
*/
	...
	/*
	glnd.plate101 (keep = id dfseq dt_infect cult_obtain cult_positive cult_org_code_1 org_spec_1 )
...
***/
	...
	* reduce dataset to only those infections which have changed ;
	...
	title "SHOWING CHANGED ORGANISMS ";
	proc print data = adj_changed;
		var id infect_visitno agree_site cult_a_no cult_a_code cult_org_code_1 cult_org_code_2  cult_org_code_3 ;
	run;
...
/*
	proc print data = adj_changed;
		where agree_site = 0;
		var id infect_visitno infect_confirm infect_confirm_adj site_code site_code_adj type_code type_code_adj;
	run;
*/

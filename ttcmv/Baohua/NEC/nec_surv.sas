...
symbol2 i=stepjl mode=exclude value=none co=red cv=red height=0.6 bwidth=4 width=1.5 l=3;
symbol3 i=stepjl mode=exclude value=none co=red cv=red height=0.6 bwidth=4 width=1.5 l=3;


title h=3 justify=center Cumulative Incidence of NEC and 95% Confidence Intervals Among &n0 LBWIs;

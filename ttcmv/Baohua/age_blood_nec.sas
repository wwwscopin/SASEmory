...
goptions reset=global gunit=pct noborder colors=(orange green red) ftitle=triplex  ftext=triplex   htitle=3.5 htext=3;
		...
		%let descrip1 = "Bar Chart for Age of Blood of RBC Transfusions(non-NEC) (median=&median_age0 days)";
		%let descrip2 = "Bar Chart for Age of Blood of RBC Transfusions(NEC) (median=&median_age1 days)";
		%let descrip3 = "Bar Chart for Irradiation Days of Blood of RBC(non-NEC) Transfusions (median=&median_ir0 days)";
		%let descrip4 = "Bar Chart for Irradiation Days of Blood of RBC Transfusions(NEC) (median=&median_ir1 days)";
    	...
    	axis2 label=(a=90 h=3 c=black "#RBC Transfusions") order=(0 to 400 by 20) minor=none;

...
proc format; 
    value group -1="Group*(m|n)" 0="Transfused without NEC*(&m0|&n0) " 1 = "Transfused <=48 hrs before NEC*(&m1|&n1)" 2 = "Transfused >48 hrs before NEC*(&m2|&n2)" 3=" ";              
run;
...
axis1 	label=(f=triplex h=3 ' ' ) value=(f=triplex h=2.0) split="*" order= (-1 to 3 by 1 ) minor=none offset=(0 in, 0 in);
...
symbol1 i=none mode=exclude value=dot co=black cv=black h=2.5 w=1; 	 
symbol2 ci=blue value=circle h=0.5;         
symbol3 ci=red value=dot h=1;    
        		...
        		proc gplot data=tmp gout=gcx.graphs;
         			...
         			plot   estimate*nidx left_&var*nidx1 sub_&var*nidx1/overlay annotate= anno haxis = axis1 vaxis = axis2  nolegend;
          			...
          			note h=1.5 m=(45pct, 5 pct) "*Dots in Red color-> pRBC(0-2 days) before NEC" ;
          		run;	

symbol1 interpol=boxt mode=exclude value=none co=black cv=black height=1 bwidth=5 width=2; 	 
symbol2 ci=blue value=circle h=0.75;         
symbol3 ci=red value=dot h=1;  
        		...
        		proc gplot data=&data gout=gcx.graphs;
                    title " ";
         			plot   &var*nidx left_&var*nidx1 sub_&var*nidx1/overlay haxis = axis1 vaxis = axis2  nolegend;
          			...
          			note h=1.5 m=(45pct, 5 pct) "*Dot in red color-> Transfused <=48 hrs before NEC" ;
          		run;	   		
...
ods rft file="age_blood_mixed.rtf" style=journal bodytitle;

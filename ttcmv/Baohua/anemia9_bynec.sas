...
title1 h=3 justify=center Cumulative incidence of anemia (Hb<=9 g/dl) for NEC (n=&m) and Control LBWIs (n=&n);
...
filename output 'anemia9_nec_surv.eps';
goptions reset=all BORDER device=pslepsfc gsfname=output gsfmode=replace ;

ods pdf file = "anemia9_nec_km_curve.pdf";

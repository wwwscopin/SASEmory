...
data anemia;
    ...
    keep id nec anemia anemia28 hbdate hb;
run;
...
axis2 	label=(h=2.5 a=90 "Probability of Anemia (Hb<=9 g/dL)") order=(0 to 1 by 0.05) value=(h=2) ;
...
filename output 'anemia9_rbc_surv.eps';

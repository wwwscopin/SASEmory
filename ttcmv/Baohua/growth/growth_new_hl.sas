...
proc mixed data=hwl /*method=ml*/ ORDER=internal;
        ...
        model htlength=tx day day*tx/s chisq;
...
*ods trace off;
/*
data cmv.hl_slope(where=(effect='day'));
    set ind_slope;
run;
proc print;run;
*/
...
axis2 	label=(h=2.5 a=90 "Length (cm)") value=(h=2) order= (30 to 48 by 1) offset=(.25 in, .25 in) minor=(number=1);
 
title1 	height=3 "All LBWIs Length vs Age";

...
axis2 	label=(h=2.5 a=90 f=swissb "Weight(g)") value=(h=2) order= (0 to 2400 by 100) offset=(.25 in, .25 in) minor=(number=1) c=white;
...
value = (h=2 c=black "Without Anemia, Slope(SE)=&s1 g/day" "With Anemia, Slope(SE)=&s2 g/day") offset=(0.2in, -0.4 in) frame cframe=white cborder=white;

...
ods rtf file="anemia.rtf" style=journal bodytitle;
...
^n 1. For anemic group, no LBWIs died after the 1st pRBC transfusion.
^n 2. For not anemic group, there are 10 LBWIs died after the 1st pRBC transfusion.
";
...
symbol1 i=j ci=blue value=circle h=0.5 w=1 repeat=100; 
	...
	proc gplot data=tmp gout=wbh.graphs;
		title h=3.5 justify=center &description, "Anemic (n=&a0)";  
	...
	proc gplot data=tmp gout=wbh.graphs;
		title h=3.5 justify=center &description, "Anemic (n=&a1)";  
		note h=2 m=(2pct, 8.5 pct) "Days:" ;
		where anemic8=1 and day>0; 
	...
	proc gplot data=tmp gout=wbh.graphs;
		title h=3.5 justify=center &description, "Not Anemic (n=&na0)";  
		note h=2 m=(2pct, 8.5 pct) "Days:" ;
	...
	proc gplot data=tmp gout=wbh.graphs;
		title h=3.5 justify=center &description, "Not Anemic (n=&na1)";  
		note h=2 m=(2pct, 8.5 pct) "Days:" ;
		where anemic8=0 and day>=0; 
		plot &variable*day=id/ overlay haxis = axis3 vaxis = axis2  nolegend vref=8 lvref=20 /*href=0 lhref=20*/; 
		format &variable 5.0;
...
* clear graph catalog ;
  	...
  	ods pdf file = "anemia.pdf" startpage=no;

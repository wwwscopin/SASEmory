...
*/	
    ...
    value = ( h=2 c=black "Non-NEC" "NEC") offset=(-0.2in, -0.4 in) frame cframe=white cborder=black;
	...
	ods pdf file = "hb_nec_slope1.pdf" style=journal;
			proc gplot data= nec_estimate;
				...
				note h=1.5 m=(1pct, 11 pct) "Day :" ;
               	note h=1.5 m=(1pct, 9 pct) "#Non-NEC" ;
               	note h=1.5 m=(1pct, 7 pct) "#NEC" ;
			run;	

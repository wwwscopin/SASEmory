...
data nec;
	...
	if  -1<=day<=0 then dday=0;
	else if -5<=day<=-2 then dday=-4;
	...
	if hb<6 or hb>25 or day=. or day<-200 or hbdate<dob then delete;
...
data _null_;
	...
	if nec=2 and dday=0  then call symput( "c0",   compress(_freq_));
...
value dta   
 1=" " 0="&a0" -1=" "  -2=" " -3=" " -4 = "&a4" -5=" " -6=" " -7="&a7" -8=" " -9=" " -10=" " 
...
value dtb   
 1=" " 0="&b0" -1=" "  -2=" " -3=" " -4 = "&b4" -5=" " -6=" " -7="&b7" -8=" " -9=" " -10=" " 
...
value dtc   
 1=" " 0="&c0" -1=" "  -2=" " -3=" " -4 = "&c4" -5=" " -6=" " -7="&c7" -8=" " -9=" " -10=" " 
...
proc mixed data=nec covtest method=MIVQUE0;
	class id nec;
	model hb=nec day nec*day birthweight/s;
	...
	estimate "No tx, intercept" int 1 nec 1 0 0 birthweight &nbw/cl;
	estimate "No tx, Day4"  int 1 nec 1 0 0 day -4  day*nec -4  0 0 birthweight &nbw;
	estimate "No tx, Day7"  int 1 nec 1 0 0 day -7  day*nec -7  0 0 birthweight &nbw;
	estimate "No tx, Day14" int 1 nec 1 0 0 day -14 day*nec -14 0 0 birthweight &nbw;
	estimate "No tx, Day21" int 1 nec 1 0 0 day -21 day*nec -21 0 0 birthweight &nbw;
	estimate "No tx, Day28" int 1 nec 1 0 0 day -28 day*nec -28 0 0 birthweight &nbw;
	estimate "No tx, Day40" int 1 nec 1 0 0 day -40 day*nec -40 0 0 birthweight &nbw;
	estimate "No tx, Day60" int 1 nec 1 0 0 day -60 day*nec -60 0 0 birthweight &nbw/e;

	estimate "Yes NEC, intercept" int 1 nec 0 1 0 birthweight &nbw/cl;
	estimate "    NEC, Day4"  int 1 nec 0 1 0 day -4  day*nec 0 -4  0 birthweight &nbw;
	estimate "    NEC, Day7"  int 1 nec 0 1 0 day -7  day*nec 0 -7  0 birthweight &nbw;
	estimate "    NEC, Day14" int 1 nec 0 1 0 day -14 day*nec 0 -14 0 birthweight &nbw;
	estimate "    NEC, Day21" int 1 nec 0 1 0 day -21 day*nec 0 -21 0 birthweight &nbw;
	estimate "    NEC, Day28" int 1 nec 0 1 0 day -28 day*nec 0 -28 0 birthweight &nbw;
	estimate "    NEC, Day40" int 1 nec 0 1 0 day -40 day*nec 0 -40 0 birthweight &nbw;
	estimate "    NEC, Day60" int 1 nec 0 1 0 day -60 day*nec 0 -60 0 birthweight &nbw/e;
	
	estimate "Yes tx, intercept" int 1 nec 0 0 1 birthweight &nbw/cl;
	estimate "Yes tx, Day4"  int 1 nec 0 0 1 day -4  day*nec 0 0 -4  birthweight &nbw;
	estimate "Yes tx, Day7"  int 1 nec 0 0 1 day -7  day*nec 0 0 -7  birthweight &nbw;
	estimate "Yes tx, Day14" int 1 nec 0 0 1 day -14 day*nec 0 0 -14 birthweight &nbw;
	estimate "Yes tx, Day21" int 1 nec 0 0 1 day -21 day*nec 0 0 -21 birthweight &nbw;
	estimate "Yes tx, Day28" int 1 nec 0 0 1 day -28 day*nec 0 0 -28 birthweight &nbw;
	estimate "Yes tx, Day40" int 1 nec 0 0 1 day -40 day*nec 0 0 -40 birthweight &nbw;
	estimate "Yes tx, Day60" int 1 nec 0 0 1 day -60 day*nec 0 0 -60 birthweight &nbw/e;
...
*/	
	...
	axis1 	label=(h=3 " " ) split="*"	
	   value=(h=1.25) major=(c=black) origin=(,15)pct order= (-61 to 1 by 1) minor=none offset=(0 in, 0 in);
	...
	ods pdf file = "hb_nec_slope1_tx_birthweight.pdf" style=journal;
			proc gplot data= nec_estimate;
				...
				note h=3 m=(5pct, 0 pct) "Days Before the First NEC Diagnosis (NEC) or Days Before the Last Measured Hemoglobin(non-NEC)" ;

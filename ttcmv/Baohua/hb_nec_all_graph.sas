...
goptions reset=global rotate=landscape gunit=pct noborder CBACK=blue ctext=white ctitle=white colors=(orange green red)
	...
	axis1 	label=(h=3 "Days Before the Last Hemoglobin Measurement Or Days Before Initial NEC Diagnosis" ) split="*"	value=(h=1.25) c=white order= (-61 to 1 by 1) minor=none offset=(0 in, 0 in);

...
proc mixed data=nec covtest method=MIVQUE0;
	...
	estimate "No tx, Day1"  int 1 nec 1 0 0 day 1  day*nec 1  0 0 birthweight &nbw;
	...
	estimate "    NEC, Day1"  int 1 nec 0 1 0 day 1  day*nec 0 1  0 birthweight &nbw;
	...
	estimate "Yes tx, Day1"  int 1 nec 0 0 1 day 1  day*nec 0 0 1 birthweight &nbw;
...
*/	
	...
	ods pdf file = "hb_nec_slope_tx_birthweight.pdf" style=journal;

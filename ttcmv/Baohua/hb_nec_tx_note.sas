...
proc mixed data=nec covtest method=MIVQUE0;
	...
	estimate "No tx, intercept" int 1 nec 1 0 0 /cl;
	estimate "No tx, Day1"  int 1 nec 1 0 0 day 1  day*nec 1  0 0 ;
	estimate "No tx, Day4"  int 1 nec 1 0 0 day 4  day*nec 4  0 0 ;
	estimate "No tx, Day7"  int 1 nec 1 0 0 day 7  day*nec 7  0 0 ;
	estimate "No tx, Day14" int 1 nec 1 0 0 day 14 day*nec 14 0 0 ;
	estimate "No tx, Day21" int 1 nec 1 0 0 day 21 day*nec 21 0 0 ;
	estimate "No tx, Day28" int 1 nec 1 0 0 day 28 day*nec 28 0 0 ;
	estimate "No tx, Day40" int 1 nec 1 0 0 day 40 day*nec 40 0 0 ;
	estimate "No tx, Day60" int 1 nec 1 0 0 day 60 day*nec 60 0 0 /e;

	estimate "Yes NEC, intercept" int 1 nec 0 1 0 /cl;
	estimate "    NEC, Day1"  int 1 nec 0 1 0 day 1  day*nec 0 1  0 ;
	estimate "    NEC, Day4"  int 1 nec 0 1 0 day 4  day*nec 0 4  0 ;
	estimate "    NEC, Day7"  int 1 nec 0 1 0 day 7  day*nec 0 7  0 ;
	estimate "    NEC, Day14" int 1 nec 0 1 0 day 14 day*nec 0 14 0 ;
	estimate "    NEC, Day21" int 1 nec 0 1 0 day 21 day*nec 0 21 0 ;
	estimate "    NEC, Day28" int 1 nec 0 1 0 day 28 day*nec 0 28 0 ;
	estimate "    NEC, Day40" int 1 nec 0 1 0 day 40 day*nec 0 40 0 ;
	estimate "    NEC, Day60" int 1 nec 0 1 0 day 60 day*nec 0 60 0 /e;
	
	estimate "Yes tx, intercept" int 1 nec 0 0 1 /cl;
	estimate "Yes tx, Day1"  int 1 nec 0 0 1 day 1  day*nec 0 0 1 ;
	estimate "Yes tx, Day4"  int 1 nec 0 0 1 day 4  day*nec 0 0 4 ;
	estimate "Yes tx, Day7"  int 1 nec 0 0 1 day 7  day*nec 0 0 7 ;
	estimate "Yes tx, Day14" int 1 nec 0 0 1 day 14 day*nec 0 0 14 ;
	estimate "Yes tx, Day21" int 1 nec 0 0 1 day 21 day*nec 0 0 21 ;
	estimate "Yes tx, Day28" int 1 nec 0 0 1 day 28 day*nec 0 0 28 ;
	estimate "Yes tx, Day40" int 1 nec 0 0 1 day 40 day*nec 0 0 40 ;
	estimate "Yes tx, Day60" int 1 nec 0 0 1 day 60 day*nec 0 0 60 /e;
...
goptions reset=global rotate=landscape gunit=pct noborder cback=white	colors = (black red) ;


	symbol1 i=j ci=red value=dot co=red cv=red h=3 w=2;
	symbol2 i=j ci=black value=square co=black cv=black h=3 w=2;

	   
	axis1 	label=(h=3 " " ) split="*"	
	   value=(h=1.25) major=(c=black) origin=(,15)pct order= (-1 to 15 by 1) minor=none offset=(0 in, 0 in);
	   
	axis2 	label=(h=3 a=90 "Hemoglobin(g/dL)") value=(h=2.5) c=black order= (11 to 14 by 0.2) offset=(.25 in, .25 in) minor=(number=1); 
	...
	title1 	height=4 "Hemoglobin vs Days ( NEC=&n1(&m1 obs), non-NEC with tx=&n2(&m2 obs))";
	/*title2 	height=2.5 "Slope of Non-NEC without tx=&sp0, Slope of Non-NEC with tx=&sp2, Slope of NEC=&sp1";*/
	title2 	height=3 "Slope of Non-NEC with tx=&sp2, Slope of NEC=&sp1; Test of equal slopes: p=&p3";
	...
	ods pdf file = "hb_nec_slope_tx.pdf" style=journal;
			proc gplot data= nec_estimate;
				plot /*estimate0*day*/ estimate1*day estimate2*day2/overlay annotate= anno haxis = axis1 vaxis = axis2 legend=legend;
				format estimate0 estimate1 estimate2 4.1 day dd.;
				
				note h=3 m=(20pct, 0 pct) "Age Before the First NEC Diagnosis (NEC) or Age of non-NEC LBWIs" ;
				
				note h=1.5 m=(4pct, 11 pct) "Day :" ;
               	/*note h=1.5 m=(4pct, 9 pct) "#Non-NEC no Tx"*/ ;
               	note h=1.5 m=(4pct, 7 pct) "#NEC" ;
               	note h=1.5 m=(4pct, 5 pct) "#Non-NEC with Tx" ;
			run;	

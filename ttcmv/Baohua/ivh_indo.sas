...
data lbwi;
	...
	keep 	id Gender LBWIDOB GestAge BirthWeight birthresus BirthResusOxygen BirthResusCPAP StudyLeftDate day 
	        ...
	        Indomethacin Apgar5Min Hypertension DeliveryMode IsChorloConfirm grade Fio2;
...
proc format;
    ...
    value item
          ...
          15="FiO2 at Birth, Median[Q1-Q3], N"
	      16="Delivery room resuscitation"
    	  17="Birth resuscitation/stabilization with Oxygen"
	      18="Birth resuscitation/stabilization with CPAP"
	      ; 
...
%let varlist=grade gplt tbc ttbc plt idx_plt Hypertension IsChorloConfirm DeliveryMode birthresus BirthResusOxygen BirthResusCPAP;
...
ods rtf file="tab_ivh.rtf" style=journal bodytitle ;
proc report data=tab_ivh nowindows style(column)=[just=center] split="*";
title "Approach #2: Impact of Prophylactic Indomethacin and Initial Platelet Count on IVH";
where item<11;
...
^n
*** There were 3 LBWIs with IVH treated prophylactically with Indomethacin that did not have a platelet count measurement available at birth.";
ods rtf close;

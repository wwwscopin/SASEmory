...
proc print;
where ivh=1;
var id ivh plt nplt idx_plt imagedate;
run;
...
%let varlist=gender race ismultiple death pda gplt tbc ttbc plt idx_plt Hypertension IsChorloConfirm DeliveryMode birthresus BirthResusOxygen BirthResusCPAP;
...
data tab;   
    ...
    set tab; by item code;
		...
		if item=14  then  do; code0=put(code, ny.); end;
...
ods rtf file="tab_ivh_noivh.rtf" style=journal bodytitle ;

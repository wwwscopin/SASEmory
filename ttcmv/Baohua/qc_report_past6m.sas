...
define month_display2 / left group  order=data        style(column)=[cellwidth=1in just=left]  "";
define center / left  group  style(column)=[cellwidth=1in just=left]  "Site";
define tot_records / center       style(column)=[cellwidth=1in just=center]  ;
define qcs_created / center       style(column)=[cellwidth=1in just=center]  ;
define qc_quotient / center       style(column)=[cellwidth=1in just=center]  ;

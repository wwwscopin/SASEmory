...
**** post-process data ****;
	...
	data qcs;
		set wbh.qcs (keep = 	status plate field plate dfseq center report_num problem_code 
...
*ods rtf file = "qc_table.rtf"  style = journal toc_data startpage = yes bodytitle;

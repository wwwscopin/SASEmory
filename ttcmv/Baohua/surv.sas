...
symbol1 i=stepjl mode=exclude value=none co=black cv=black height=0.6 bwidth=4 width=1.5 l=1;
...
axis1 	label=(h=2.5 'Age of Low Birth Weight Infants' ) split="*" value=(h=2) order= (0 3 7 to 56 by 7) minor=none;
axis2 	label=(h=2.5 a=90 f=zapf "Probability of IVH") order=(0 to 0.20 by 0.05) value=(h=2) ;
     
             
proc gplot data=pl gout=wbh.graphs;
	plot  prob*day lower*day upper*day/overlay haxis = axis1 vaxis = axis2  nolegend;

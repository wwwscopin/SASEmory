/* CREATED BY: aknezev Dec 02,2010 12:36PM using DFsas */
/*   VERSIONS: DFsas 3.8.3, May and .DFsas.awk 3.8.3, May */
options YEARCUTOFF=1920;

filename data1 '/dfax/ttcmv/sas/programs/data_mgt/plate_121.d01';
data cmv.nec_image_case1(label="NEC Image x Case 1 p1/1");

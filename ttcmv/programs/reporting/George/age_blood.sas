...
data tx_id;
	set cmv.plate_031(keep=id DonorUnitId DateTransfusion rbc_TxStartTime)
			/*cmv.plate_033(keep=id DonorUnitId DateTransfusion)
			cmv.plate_035(keep=id DonorUnitId DateTransfusion)
			cmv.plate_037(keep=id DonorUnitId DateTransfusion)

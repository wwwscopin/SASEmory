...
data lbwi_demo1; set lbwi_demo; if cohort = 1 & evertxn = 0; run;
data lbwi_demo2; set lbwi_demo; if cohort = 2 & evertxn = 0; run;
data lbwi_demo3; set lbwi_demo; if cohort = 1 & evertxn = 1; run;
data lbwi_demo4; set lbwi_demo; if cohort = 2 & evertxn = 1; run;

data singletons1; set lbwi_demo1; if singleton = 1; run;
data singletons2; set lbwi_demo2; if singleton = 1; run;
data singletons3; set lbwi_demo3; if singleton = 1; run;
data singletons4; set lbwi_demo4; if singleton = 1; run;
...
* Merge tables and headers;
	...
	* SECTION 1 ***********************************************************************************************************;
	data header1; length row $ 80; row = "^S={font_weight=bold font_size=2}" || "Demographic factors"; run;
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary1, var= Gender, type= bin, first_var=1);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary1, var= IsHispanic, type= bin);	
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary1, var= race, type= cat, last_var=1);
	* SECTION 2 ***********************************************************************************************************;
	data header2; length row $ 80; row = "^S={font_weight=bold font_size=2}" || "Anthropometric data at birth*"; run;
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary2, var= GestAge, type= cont, non_param=0, first_var=1);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary2, var= BirthWeight, type= cont, non_param=0, dec_places=0);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary2, var= bw_cat, type= cat);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary2, var= singleton, type= bin);
	%descriptive_stat(data_in= singletons3, data_out= lbwi_demo_summary2, var= olsen_weight_z, type= cont, non_param=0, dec_places=1);
	%descriptive_stat(data_in= singletons3, data_out= lbwi_demo_summary2, var= olsen_weight_tenth, type= bin, non_param=0);
	%descriptive_stat(data_in= singletons3, data_out= lbwi_demo_summary2, var= olsen_weight_fiftieth, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary2, var= Length, type= cont, non_param=0);
	%descriptive_stat(data_in= singletons3, data_out= lbwi_demo_summary2, var= olsen_length_z, type= cont, non_param=0, dec_places=1);
	%descriptive_stat(data_in= singletons3, data_out= lbwi_demo_summary2, var= olsen_length_tenth, type= bin, non_param=0);
	%descriptive_stat(data_in= singletons3, data_out= lbwi_demo_summary2, var= olsen_length_fiftieth, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary2, var= HeadCircum, type= cont, non_param=0);
	%descriptive_stat(data_in= singletons3, data_out= lbwi_demo_summary2, var= olsen_hc_z, type= cont, non_param=0, dec_places=1);
	%descriptive_stat(data_in= singletons3, data_out= lbwi_demo_summary2, var= olsen_hc_tenth, type= bin, non_param=0);
	%descriptive_stat(data_in= singletons3, data_out= lbwi_demo_summary2, var= olsen_hc_fiftieth, type= bin, non_param=0, last_var=1);
	* SECTION 3 ***********************************************************************************************************;
	data header3; length row $ 80; row = "^S={font_weight=bold font_size=2}" || "Neonatal health scores and birth risk factors"; run;
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary3, var= Apgar1Min, type= cont, non_param=0, first_var=1);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary3, var= Apgar5min, type= cont, non_param=0);
	* Include SNAP Score ;
	data snap; set cmv.snap;	label SNAPTotalScore = "SNAP - mean (sd), N"; run;
	data lbwi_demo3; merge lbwi_demo3 (in=a) snap (keep = SNAPTotalScore); if a; run;
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary2, var= SNAPTotalScore, type= cont, non_param=0);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary3, var= IsOutborn, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary3, var= BirthResus, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary3, var= BirthResusoxygen, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary3, var= BirthResuscompression, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary3, var= BirthResuscpap, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary3, var= BirthResusepi, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary3, var= BirthResusintubation, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary3, var= BirthResusmask, type= bin, non_param=0, last_var=1);
	* SECTION 4 ***********************************************************************************************************;
	data header4; length row $ 80; row = "^S={font_weight=bold font_size=2}" || "Umbilical cord blood gas data"; run;
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary4, var= IsBloodGas, type= bin, non_param=0, first_var=1);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary4, var= cordph, type= cont, non_param=0);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary4, var= basedeficit, type= cont, non_param=0);
	%descriptive_stat(data_in= lbwi_demo3, data_out= lbwi_demo_summary4, var= arterial, type= bin, non_param=0, last_var=1);
	***********************************************************************************************************************;

* Merge tables and headers;
	data lbwi_demo_summary_3; 
		set 	header1 lbwi_demo_summary1 
				header2 lbwi_demo_summary2
				header3 lbwi_demo_summary3
				header4 lbwi_demo_summary4
	...
	* SECTION 1 ***********************************************************************************************************;
	data header1; length row $ 80; row = "^S={font_weight=bold font_size=2}" || "Demographic factors"; run;
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary1, var= Gender, type= bin, first_var=1);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary1, var= IsHispanic, type= bin);	
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary1, var= race, type= cat, last_var=1);
	* SECTION 2 ***********************************************************************************************************;
	data header2; length row $ 80; row = "^S={font_weight=bold font_size=2}" || "Anthropometric data at birth*"; run;
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary2, var= GestAge, type= cont, non_param=0, first_var=1);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary2, var= BirthWeight, type= cont, non_param=0, dec_places=0);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary2, var= bw_cat, type= cat);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary2, var= singleton, type= bin);
	%descriptive_stat(data_in= singletons4, data_out= lbwi_demo_summary2, var= olsen_weight_z, type= cont, non_param=0, dec_places=1);
	%descriptive_stat(data_in= singletons4, data_out= lbwi_demo_summary2, var= olsen_weight_tenth, type= bin, non_param=0);
	%descriptive_stat(data_in= singletons4, data_out= lbwi_demo_summary2, var= olsen_weight_fiftieth, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary2, var= Length, type= cont, non_param=0);
	%descriptive_stat(data_in= singletons4, data_out= lbwi_demo_summary2, var= olsen_length_z, type= cont, non_param=0, dec_places=1);
	%descriptive_stat(data_in= singletons4, data_out= lbwi_demo_summary2, var= olsen_length_tenth, type= bin, non_param=0);
	%descriptive_stat(data_in= singletons4, data_out= lbwi_demo_summary2, var= olsen_length_fiftieth, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary2, var= HeadCircum, type= cont, non_param=0);
	%descriptive_stat(data_in= singletons4, data_out= lbwi_demo_summary2, var= olsen_hc_z, type= cont, non_param=0, dec_places=1);
	%descriptive_stat(data_in= singletons4, data_out= lbwi_demo_summary2, var= olsen_hc_tenth, type= bin, non_param=0);
	%descriptive_stat(data_in= singletons4, data_out= lbwi_demo_summary2, var= olsen_hc_fiftieth, type= bin, non_param=0, last_var=1);
	* SECTION 3 ***********************************************************************************************************;
	data header3; length row $ 80; row = "^S={font_weight=bold font_size=2}" || "Neonatal health scores and birth risk factors"; run;
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary3, var= Apgar1Min, type= cont, non_param=0, first_var=1);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary3, var= Apgar5min, type= cont, non_param=0);
	* Include SNAP Score ;
	data snap; set cmv.snap;	label SNAPTotalScore = "SNAP - mean (sd), N"; run;
	data lbwi_demo4; merge lbwi_demo4 (in=a) snap (keep = SNAPTotalScore); if a; run;
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary2, var= SNAPTotalScore, type= cont, non_param=0);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary3, var= IsOutborn, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary3, var= BirthResus, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary3, var= BirthResusoxygen, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary3, var= BirthResuscompression, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary3, var= BirthResuscpap, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary3, var= BirthResusepi, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary3, var= BirthResusintubation, type= bin, non_param=0);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary3, var= BirthResusmask, type= bin, non_param=0, last_var=1);
	* SECTION 4 ***********************************************************************************************************;
	data header4; length row $ 80; row = "^S={font_weight=bold font_size=2}" || "Umbilical cord blood gas data"; run;
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary4, var= IsBloodGas, type= bin, non_param=0, first_var=1);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary4, var= cordph, type= cont, non_param=0);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary4, var= basedeficit, type= cont, non_param=0);
	%descriptive_stat(data_in= lbwi_demo4, data_out= lbwi_demo_summary4, var= arterial, type= bin, non_param=0, last_var=1);
	***********************************************************************************************************************;

* Merge tables and headers;
	data lbwi_demo_summary_4; 
		set 	header1 lbwi_demo_summary1 
				header2 lbwi_demo_summary2
				header3 lbwi_demo_summary3
				header4 lbwi_demo_summary4
	...
	data lbwi_demo_summary_4; set lbwi_demo_summary_4; order = _N_; run;
	proc sort data = lbwi_demo_summary_1; by row; run;
	proc sort data = lbwi_demo_summary_2; by row; run;
	proc sort data = lbwi_demo_summary_3; by row; run;
	proc sort data = lbwi_demo_summary_4; by row; run;
	data lbwi_demo_summary; merge 
		lbwi_demo_summary_1 (rename = (disp_overall = disp1)) 
		lbwi_demo_summary_2 (rename = (disp_overall = disp2))
		lbwi_demo_summary_3 (rename = (disp_overall = disp3)) 
		lbwi_demo_summary_4 (rename = (disp_overall = disp4)); 
		by row; 
	run;
	proc sort data = lbwi_demo_summary; by order; run;

	proc sql; select count(*) into :n1 from lbwi_demo1;
	proc sql; select count(*) into :n2 from lbwi_demo2;
	proc sql; select count(*) into :n3 from lbwi_demo3;
	proc sql; select count(*) into :n4 from lbwi_demo4;

	data lbwi_demo_summary; set lbwi_demo_summary; 	
		keep row disp1 disp2 disp3 disp4; 
		label 	disp1 = "MOC Seronegative*Never Transfused*(n = &n1)"
					disp2 = "MOC Seropositive*Never Transfused*(n = &n2)"
					disp3 = "MOC Seronegative*Transfused*(n = &n3)"
					disp4 = "MOC Seropositive*Transfused*(n = &n4)"
				;
	run;
	...
	ods rtf file = "&output./april2011abstracts/lbwi_demo_summary_by_cohort_txn.rtf"  style=journal toc_data startpage = no bodytitle;
		title1 "LBWI Demographic and Birth Characteristics Summary - By MOC CMV Serology Cohort & Ever Transfused"; 
		...
		proc print data = lbwi_demo_summary label noobs split = "*" style(header) = {just=center} contents = "";
			...
			by  row notsorted;
				var disp1 disp2 disp3 disp4 /style(data) = [just=center font_size=1.8];
			run;
	ods rtf close;

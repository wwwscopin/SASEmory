...
ods graphics on;
*ods trace on/label listing;
proc lifetest data=anemia_nec plots=s confband=all outsurv=pl1;
...
             
proc gplot data=km gout=wbh.graphs;
	plot prob*day=nec/ haxis = axis1 vaxis = axis2  legend=legend1;
	format day dd. prob 4.2;
run;

...
value dt   
 0="0" 1="1-2"  2=" " 3=" " 4 = "3-5" 5=" " 6=" " 7="6-9" 8=" " 9=" " 10=" " 
 11=" " 12=" " 13=" " 14 = "10-17" 15=" " 16=" " 17=" " 18=" " 19=" " 20=" " 
 21="18-24" 22=" " 23=" " 24=" " 25=" " 26=" " 27=" " 28 = "25-34"  29=" " 30=" "
...
goptions reset=global rotate=landscape gunit=pct noborder cback=white	colors = (black red) ;
	...
	symbol3 i=j ci=black value=square cv=black co=black h=3 w=2;

	   
	axis1 	label=(h=3 " " ) split="*"	
	   value=(h=1.25) major=(c=black) origin=(,15)pct order= (-1 to 31 by 1) minor=none offset=(0 in, 0 in);
	...
	title1 	height=4 "Means Model: Hemoglobin vs Days (non-NEC without tx=&n0(&m0 obs), NEC=&n1(&m1 obs), non-NEC with tx=&n2(&m2 obs))";
	title2 	height=2.5 "p(NEC)=&pn, p(Day)=&pd, p(NEC*Day)=&pi";

	ods pdf file = "hb_nec_tx_repeated_month.pdf" style=journal;
			proc gplot data= nec_estimate;
				...
				note h=1.5 m=(0pct, 11 pct) "Day :" ;
               	note h=1.5 m=(0pct, 9 pct) "#Non-NEC no Tx" ;
               	note h=1.5 m=(0pct, 7 pct) "#NEC" ;
               	note h=1.5 m=(0pct, 5 pct) "#Non-NEC with Tx" ;
			run;	

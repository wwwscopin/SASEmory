...
title1 'Bar chart for Age of blood and Irradiation days for RBC Transfusions';
...
axis2 order=(-120 to 0 by 20 50 to 600 by 50) label=("# of RBC Transfusions") minor = none
value = ("120" "100" "80" "60" "40" "20" "0");

Legend1 value=(color=black height=2.5 "Storage Age of Blood (median=&median_age days)" "Days from Date of Irradiation to Date of Transfusion (median=&median_ir days)") label=none;

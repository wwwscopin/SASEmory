...
title1 h=3 justify=center Cumulative incidence of anemia (Hb<=8 g/dl) for NEC (n=&m) and Control LBWIs (n=&n);
...
filename output 'anemia8_nec_surv.eps';
goptions reset=all BORDER device=pslepsfc gsfname=output gsfmode=replace ;

ods pdf file = "anemia8_nec_km_curve.pdf";

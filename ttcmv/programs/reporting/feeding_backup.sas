...
value item  1="Total days of parenteral nutrition: Median[min-max], N"
            ...
            8="No. of days baby received any breast milk in first 28 days:"; 
run;
...
proc print data=feed;run;
proc print data=med;run;
...
by item;
id item/style=[cellwidth=4in just=left];
var nf1-nf3 nf/style=[just=center cellwidth=1.25in];
label item="Question"
      nf1="Midtown*(&n1)"
      nf2="Grady*(&n2)"
      nf3="Northside*(&n3)"
...
*The denominator for this row is the number of patients who regained their birth weight; 

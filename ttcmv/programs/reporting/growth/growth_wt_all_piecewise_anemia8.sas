...
order= (-41 to 41 by 1) minor=none offset=(0 in, 0 in) ;
...
value = (h=2 c=black "Without Anemia, Slope(SE)=&s1 g/day" "With Anemia, Slope(SE)=&s2 g/day") offset=(-0.5in, -0.2 in) frame;

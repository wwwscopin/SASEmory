...
title2 	height=2.5 "n(With Anemia(Hb<=9))=&yes, n(Without Anemia(Hb>9))=&no";
...
value = (h=2 c=black "Without Anemia, Slope(SE)=&s1 g/day" "With Anemia, Slope(SE)=&s2 g/day") offset=(-2in, -0.4 in) frame cframe=white cborder=white;
...
ods pdf file = "growth_anemia9.pdf";

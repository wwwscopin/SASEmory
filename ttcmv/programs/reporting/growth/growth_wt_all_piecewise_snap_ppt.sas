...
axis2 	label=(h=2.5 a=90 f=swissb "Weight(g)") value=(h=2)c=white order= (400 to 2400 by 100) offset=(.25 in, .25 in) minor=(number=1);
...
value = (h=2 c=black "SNAP<=Median(&median), Slope(SE)=&s1 g/day" "SNAP>Median(&median), Slope(SE)=&s2 g/day") offset=(-2.5in, -0.4 in) frame cframe=white cborder=white;

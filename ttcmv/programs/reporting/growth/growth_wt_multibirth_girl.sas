...
data hwl;
	...
	keep id DFSEQ Weight WeightDate HeadCircum HeadDate HtLength HeightDate MultipleBirth gender;
	rename DFSEQ=day;
	if MultipleBirth and gender=2;
run;
...
title1 	height=3 f=zapf "Multiple Birth LBWIs (Girls) Weight vs Age";
...
ods pdf file = "growth_multibirth_girl.pdf";
...
title "Multiple Birth LBWIs (Girls) Growth Rate (n=&total)";

...
proc mixed data=hwl_C /*covtest*/;
	class id tx t;
	model weight=tx st1 st2 st1*tx st2*tx/s chisq;
    repeated t/type=un subject=id r;

	estimate "No-Tx, slope" st2 1 tx*st2 1 0 0;
	estimate "Before, slope" st2 1 tx*st2 0 1 0;
	estimate "After, slope" st2 1 tx*st2 0 0 1;
...
proc mixed method=ml data=hwl_C covtest;
	...
	estimate "Before 1st Tx, intercept" tx 0 1 0;
	estimate "Before 1st Tx, slope"  wk 1 tx*wk 0 1 0;
	estimate "Before 1st Tx, Month1"  tx 0 1 0 wk 4.286 tx*wk 0 4.286 0;  

	estimate "After 1st Tx, intercept"  tx 0 0 1;
	estimate "After 1st Tx, slope"   wk 1 tx*wk 0 0 1;
	estimate "After 1st Tx, Month1"   tx 0 0 1 wk 4.286 tx*wk 0 0 4.286;  
	estimate "After 1st Tx, Month2"   tx 0 0 1 wk 8.572 tx*wk 0 0 8.572;  

/*
	estimate "Compare slopes between No-Tx and Before 1st Tx" tx*wk 1 -1  0;
	estimate "Compare slopes between No-Tx and After 1st Tx"  tx*wk 1  0 -1;
	estimate "Compare slopes between Before 1st Tx and After 1st Tx" tx*wk 0  1 -1;
*/

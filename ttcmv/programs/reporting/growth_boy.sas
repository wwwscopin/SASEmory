...
proc format;
		value tx 0="No"		1="Yes"	;
		value group 1="Group 1"		2="Group 2"	;
run;

data hwl;
	merge cmv.plate_015 cmv.plate_008 cmv.plate_006(keep=id gestage)
	...
	adjust_ga=40-gestage;
	gca=intck('week',LBWIDOB, WeightDate)-adjust_ga;
	
	keep id DFSEQ Weight WeightDate HeadCircum HeadDate HtLength HeightDate MultipleBirth gender LBWIDOB gp bw gestage gca;
	rename DFSEQ=day;
...
symbol2 i=j ci=blue value=dot co=blue cv=blue h=2 w=2;
symbol3 i=j ci=red value=triangle co=red cv=red h=2 w=2;
...
title1 	height=3 f=zapf "Singleton LBWIs (Boys) Weight vs Age";
...
ods pdf file = "growth_singleton_boy.pdf";
...
title "Singleton LBWIs (Boys) Growth Rate (n=&total)";

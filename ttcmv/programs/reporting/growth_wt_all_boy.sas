...
data hwl;
	...
	keep id DFSEQ Weight WeightDate HeadCircum HeadDate HtLength HeightDate MultipleBirth gender gestage SNAPTotalScore hb;
	rename DFSEQ=day;
	if gender=1;
run;
...
title1 	height=3 f=zapf "All LBWIs (Boys) Weight vs Age";
...
ods pdf file = "growth_all_boy.pdf";
...
title "All LBWIs (Boys) Growth Rate (n=&total)";

...
value item 0="--"
           ...
           *4="Anemia(Hemoglobin<=9 g/dL) before 1st pRBC transfusion"
           ...
           7="Caffeine used before 1st pRBC transfusion"
           ;
...
legend across = 1 position=(top left inside) mode = reserve fwidth =.2	shape = symbol(3,2) label=NONE 
value = (h=2 "Pre-1st pRBC transfusion, Slope(SE)=&sb g/day; Post-1st pRBC transfusion, Slope(SE)=&sa g/day" )  offset=(0in, -0.4 in) frame;
...
%let varlist=gender race  center anemic snapg;
*ods trace on/label listing;

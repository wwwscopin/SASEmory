...
data hwl;
	...
	rename DFSEQ=day;
	if not MultipleBirth and gender=2;
run;
...
title1 	height=3 f=zapf "Singleton LBWIs (Girls) Weight vs Age";
...
ods pdf file = "growth_singleton_girl.pdf";
...
title "Singleton LBWIs (Girls) Growth Rate (n=&total)";

...
*/	
	...
	axis2 	label=(h=3 a=90 "Hemoglobin(g/dL)") value=(h=2.5) c=black order= (8 to 18 by 1) offset=(.25 in, .25 in) minor=(number=1); 
	...
	ods pdf file = "hb_nec_slope1_tx.pdf" style=journal;

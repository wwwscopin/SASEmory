...
* Merge tables and headers;
	...
	proc sql; select count(*) into :evertxn1 from cmv.lbwi_demo where evertxn=0;
	proc sql; select count(*) into :evertxn2 from cmv.lbwi_demo where evertxn=1;
	...
	ods rtf file = "&output./annual/lbwi_demo_summary_by_txn.rtf"  style=journal toc_data startpage = no bodytitle;

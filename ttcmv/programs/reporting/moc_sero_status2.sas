...
ods rtf file = "&output./monthly/&moc_sero_status_file.moc_sero_status2.rtf"  style=journal

toc_data startpage = yes bodytitle;


ods noproctitle proclabel "&moc_sero_status_title :MOC CMV Serology Status for LBWI who completed study (Overall and by Site) ";



title  justify = center "&moc_sero_status_title :MOC CMV Serology Status for LBWI who completed study(MOC =&moc0 for LBWI=&lbwi0) and by Site";

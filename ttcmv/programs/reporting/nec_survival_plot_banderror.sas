...
data pl;
	...
	if first.failed then do;
	   prob1=failure;
	   upper1=failure+1.96*stderr;
	   lower1=failure-1.96*stderr;
	end;
...
axis2 	label=(h=3 a=90 "Percentage with NEC") order=(0 to 0.20 by 0.05) value=(h=2) ;

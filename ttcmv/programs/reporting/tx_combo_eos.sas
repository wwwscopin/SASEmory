...
select compress(put(count(*),3.0)) into: center0 from endofstudy ;
select compress(put(count(*),3.0)) into: center1 from endofstudy where center=1;
select compress(put(count(*),3.0)) into: center2 from endofstudy where center=2;
select compress(put(count(*),3.0)) into: center3 from endofstudy where center=3;
...
stat = compress( put(total_lbwi,5.0)) || "\n(" || compress( put((total_lbwi/total_center)*100,5.0)) || "%)\n";


all_donors= lbwi_rbc_donor +lbwi_ffp_donor +lbwi_plt_donor+lbwi_cryo_donor;

all_donors_lbwi= all_donors *total_lbwi; 

donor_exposure= lbwi_rbc_donor + lbwi_ffp_donor +lbwi_plt_donor + lbwi_cryo_donor;


if last=1 then do; lbwi_rbc_donor=.; lbwi_plt_donor=.;lbwi_cryo_donor=.;lbwi_ffp_donor=.;end;
run;
...
select sum(all_donors_lbwi) into :x0 from donor_results where center=0 and last =0;
select sum(all_donors_lbwi) into :x1 from donor_results where center=1 and last =0;
select sum(all_donors_lbwi) into :x2 from donor_results where center=2 and last =0;
select sum(all_donors_lbwi) into :x3 from donor_results where center=3 and last =0;

update donor_results
set all_donors= &x0,all_donors_lbwi=&x0
where center=0 and last=1;

update donor_results
set all_donors= &x1,all_donors_lbwi=&x1
where center=1 and last=1;


update donor_results
set all_donors= &x2,all_donors_lbwi=&x2
where center=2 and last=1;

update donor_results
set all_donors= &x3,all_donors_lbwi=&x3
where center=3 and last=1;
...
column  last  donor_exposure  /*variable */ lbwi_rbc_donor lbwi_plt_donor  lbwi_ffp_donor lbwi_cryo_donor  center ,  ( stat  all_donors_lbwi)  dummy;

define last/ group  order=data    Left  style(column) = [just=center cellwidth=0.3in]   "  " format=last. ;
...
define all_donors_lbwi/   order=data   Left    "Total_Donors " ;
define center / across order=internal  left   style(column) = [just=center cellwidth=0.7in] ""  ;

define stat/center   width=20   style(column) = [just=center cellwidth=0.6in] " n (%)"  left ;
*define pipe/center   width=20 "  " ;
...
compute after last; 
     ...
     line &ls.*"_____";
line "---------------------------------------------------------- --";
line "\S={font_weight=bold font_size=14pt}Total: ";  
  endcomp;
...
proc sql;
select compress(put(tx_total,4.0)) into: tx0_rbc  from all_donors_tx where center=0 and tx_Type='pRBC';
select compress(put(tx_total,4.0)) into: tx1_rbc  from all_donors_tx where center=1 and tx_Type='pRBC';
select compress(put(tx_total,4.0)) into: tx2_rbc from all_donors_tx where center=2 and tx_Type='pRBC';
select compress(put(tx_total,4.0)) into: tx3_rbc from all_donors_tx where center=3 and tx_Type='pRBC';

select compress(put(tx_total,4.0)) into: tx0_FFP  from all_donors_tx where center=0 and tx_Type='FFP';
select compress(put(tx_total,4.0)) into: tx1_FFP  from all_donors_tx where center=1 and tx_Type='FFP';
select compress(put(tx_total,4.0)) into: tx2_FFP from all_donors_tx where center=2 and tx_Type='FFP';
select compress(put(tx_total,4.0)) into: tx3_FFP from all_donors_tx where center=3 and tx_Type='FFP';


select compress(put(tx_total,4.0)) into: tx0_Plt  from all_donors_tx where center=0 and tx_Type='Plt';
select compress(put(tx_total,4.0)) into: tx1_Plt  from all_donors_tx where center=1 and tx_Type='Plt';
select compress(put(tx_total,4.0)) into: tx2_Plt from all_donors_tx where center=2 and tx_Type='Plt';
select compress(put(tx_total,4.0)) into: tx3_Plt from all_donors_tx where center=3 and tx_Type='Plt';

select compress(put(tx_total,4.0)) into: tx0_Cryo  from all_donors_tx where center=0 and tx_Type='Cryo';
select compress(put(tx_total,4.0)) into: tx1_Cryo  from all_donors_tx where center=1 and tx_Type='Cryo';
select compress(put(tx_total,4.0)) into: tx2_Cryo from all_donors_tx where center=2 and tx_Type='Cryo';
select compress(put(tx_total,4.0)) into: tx3_Cryo from all_donors_tx where center=3 and tx_Type='Cryo';
...
value center 
0="Overall_N=&center0 _Tx total=&tx0_rbc"
2="Grady_N=&center2 _Tx total=&tx2_rbc"
1="EUHM_N=&center1 _Tx total=&tx1_rbc"
3="Northside_N=&center3 _Tx total=&tx3_rbc"
4="CHOA Egleston"
5="CHOA Scottish"
;
...
value center 
0="Overall_N=&center0 _Tx total=&tx0_Plt"
2="Grady_N=&center2 _Tx total=&tx2_Plt"
1="EUHM_N=&center1 _Tx total=&tx1_Plt"
3="Northside_N=&center3 _Tx total=&tx3_Plt"
4="CHOA Egleston"
5="CHOA Scottish"
;
...
value center 
0="Overall_N=&center0 _Tx total=&tx0_FFP"
2="Grady_N=&center2 _Tx total=&tx2_FFP"
1="EUHM_N=&center1 _Tx total=&tx1_FFP"
3="Northside_N=&center3 _Tx total=&tx3_FFP"
4="CHOA Egleston"
5="CHOA Scottish"
;
...
value center 
0="Overall_N=&center0 _Tx total=&tx0_Cryo"
2="Grady_N=&center2 _Tx total=&tx2_Cryo"
1="EUHM_N=&center1 _Tx total=&tx1_Cryo"
3="Northside_N=&center3 _Tx total=&tx3_Cryo"
4="CHOA Egleston"
5="CHOA Scottish"
;
